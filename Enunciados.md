1. Desenvolva um programa para realizar o cadastro e o acompanhamento das notas de alunos. 
...
O programa deve:
Criar uma estrutura para armazenar vários alunos. 
Criar uma função para cadastrar um novo aluno. 
Calcular a média das três notas de cada aluno. 
...
Informar quantos alunos foram aprovados, estão em recuperação e foram reprovados. 
Conteúdos envolvidos: variáveis, tipos de dados, objetos, arrays, funções, operadores, condicionais, forEach() e reduce(). 

2. Desenvolva um sistema de cadastro de produtos utilizando a estrutura Map. 
...
3. Considere o seguinte conjunto de produtos: 
const produtos = [
...
Listar os produtos que possuem menos de 10 unidades em estoque.
Criar um novo array contendo somente os nomes dos produtos.
Localizar um produto a partir do seu código.
Criar um novo array contendo os preços com 10% de desconto.
Calcular o valor total de cada produto em estoque (preço × quantidade).
Calcular o valor total de todo o estoque.
Verificar se existe algum produto com estoque igual a zero.
Verificar se todos os produtos possuem preço maior que zero.
...
4. Desenvolva um sistema utilizando Orientação a Objetos para representar funcionários de uma empresa.
...
5. Desenvolva um sistema simples para gerenciamento de uma biblioteca.
